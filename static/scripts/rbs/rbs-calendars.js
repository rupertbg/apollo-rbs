...
window.allresources = [
	...
	{ id: 'C03', type: 'Small Rooms', capacity: '18', level: 'c', title: 'C03',
	...
	{ id: 'C04', type: 'Small Rooms', capacity: '18', level: 'c', title: 'C04',
	description: 'Suitable for small meetings, tutorials or interviews. Features a smartboard that can be plugged into laptops and utilized as an interactive projector.' },

	{ id: 'C46', type: 'Small Rooms', capacity: '10', level: 'c', title: 'C46',
	description: 'Suitable for small meetings, tutorials or interviews. Features a wall-mounted whiteboard and projector.' },

	{ id: 'D08', type: 'Medium Rooms', capacity: '16', level: 'd', title: 'D08',
	...
	{ id: 'C31', type: 'Medium Rooms', capacity: '20', level: 'c', title: 'C31',
	description: 'C03 is a small room on level C' },

	{ id: 'C47', type: 'Medium Rooms', capacity: '14', level: 'c', title: 'C47',
	...
	{ id: 'C48', type: 'Medium Rooms', capacity: '12', level: 'c', title: 'C48',
	description: 'Compact room, well-suited for meetings or seminars, classes, tutorials and interviews. Features a wall-mounted whiteboard and projector.' },

	{ id: 'C02C05', type: 'Large Rooms', capacity: '30', level: 'c', title: 'C02 & C05',
	...
	{ id: 'C02', parentId: 'C02 & C05', type: 'Large Rooms', capacity: '15', level: 'c', title: 'C02',
	...
	{ id: 'C05', parentId: 'C02 & C05', type: 'Large Rooms', capacity: '14', level: 'c', title: 'C05',
	...
	{ id: 'C06', type: 'Large Rooms', capacity: '24', level: 'c', title: 'C06',
	...
	{ id: 'D07', type: 'Large Rooms', capacity: '16', level: 'd', title: 'D07',
	description: 'First-floor room with ample natural light. Ideal for seminars, classes or meetings. Conveniently located near our on-site café. Features wall-mounted whiteboard, data projector and in-built PC.' },

	{ id: 'C07', type: 'Common Area', capacity: '24', level: 'c', title: 'C07',
	...
	{ id: 'C10', type: 'Computer Labs', capacity: '20', level: 'c', title: 'C10',
	...
	{ id: 'C13', type: 'Computer Labs', capacity: '16', level: 'c', title: 'C13',
	...
	{ id: 'Small Lecture Theatre', type: 'Lecture Theatres', capacity: '87', title: 'Small Lecture Theatre',
...
// Custom list function, use this function to return specific variables //
